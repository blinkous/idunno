...
public class SeekbarAlert {
    ...
    public SeekbarAlert(@NonNull Context context) {
        mContext = context;
    }

    public SeekbarAlert(@NonNull Context context, String alert_mess) {
        mContext = context;
        mAlertMessage = alert_mess;
    }

    public SeekbarAlert(@NonNull Context context, String alert_mess, @StyleRes int theme) {
        mContext = context;
        mAlertMessage = alert_mess;
        mTheme = theme;
    }
